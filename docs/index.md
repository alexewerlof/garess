# garess documentation

`garess` is a terminal AI harness that talks to OpenAI-compatible endpoints
...
- **AI agents** — read the `AGENTS.md` files: the [repo root](../AGENTS.md)
  first, then the one in the package you are editing.

The [README](../README.md) is the landing page.
